...
conversion = st.selectbox("type of conversion",["kilograms to grams" ,"grams to kilograms","kilometers to meters" ,"meters to kilometers ,centimeter to kilometer ,kilometer to centimeter"])
